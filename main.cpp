...
//        { "id", 2057797340 }
//    }));
//    qDebug().noquote() << QString::fromUtf8(Module::lyric_new({
//        { "id", 1969230350 }
//    }));
//    qDebug().noquote() << QString::fromUtf8(Module::album({
//        { "id", 149114512 },
//        { "cookie", QVariantMap({
...
//        }
//    }));
//    qDebug().noquote() << QString::fromUtf8(Module::comment_music({
//        { "id", 1969230350 }
//    }));
//    qDebug().noquote() << QString::fromUtf8(Module::artists({
//        { "id", 32238754 },
//        { "cookie", QVariantMap({
//                                   { "NMTID", "00O2DrG34TkFlEnMEmCrModcwIfNuIAAAGJwN1pPg" },
//                                   { "__csrf", "a00202686d9f5bdd8d9da2a400e4f76c" },
...
//        }
//    }));
//    qDebug().noquote() << QString::fromUtf8(Module::toplist({ }));
//    qDebug().noquote() << QString::fromUtf8(Module::user_detail({
//        { "uid", 257800231 }
//    }));
    qDebug().noquote() << QString::fromUtf8(Module::artist_detail({
        { "id", 32238754 },
        { "cookie", QVariantMap({
